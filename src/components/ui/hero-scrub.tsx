    ...
    >
      ...
      >
        ...
        <div className="absolute top-8 left-8 z-50">
           <button 
             onClick={onAbort}
             className="text-[10px] font-black uppercase tracking-[0.4rem] text-[#E1E0CC]/60 hover:text-white"
           >
             [ Abort_Mission ]
           </button>
        </div>
        ...
        <div className="relative z-10 flex h-full w-full flex-col items-center justify-center gap-3 md:gap-4">
          <h2 ref={titleTopRef} aria-hidden className="font-black uppercase" style={{
            fontSize: "clamp(3.75rem, 12vw, 11rem)", lineHeight: 0.85, letterSpacing: "-0.04em", color: "#E1E0CC"
          }}>{titleTop}</h2>
          ...
          <h2 ref={titleBottomRef} aria-hidden className="font-black uppercase text-brand-accent" style={{
